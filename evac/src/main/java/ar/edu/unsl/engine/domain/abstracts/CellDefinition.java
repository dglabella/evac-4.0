...
public interface CellDefinition {
     ...
     *         the position of the neighborhood cells. Example: if a "Von Neumann" neighborhood is
     *         defined, then the list of array returned should look like []
     */
    List<int[]> setUpNeighborhood(int i, int j);
